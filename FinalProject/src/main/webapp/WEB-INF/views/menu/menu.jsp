...
">
    <ul class="nav flex-column">
        ...
        <li class="nav-item"><a class="nav-link" href="http://192.168.0.25:9090/finalproject/chat">채팅</a></li>
        ...
        <li class="nav-item"><a class="nav-link" href="<%= ctxPath %>/survey/home">설문</a></li>
